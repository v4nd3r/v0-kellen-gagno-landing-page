...
const DEFAULT_LEGAL_NOTICE = "Imagens meramente ilustrativas. Mobiliários e decoração não vinculam o contrato."
...
export function PropertyFooter({ whatsappMessage, legalNotice = DEFAULT_LEGAL_NOTICE }: PropertyFooterProps) {
      ...
      <footer className="bg-[#1a1a1a] py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            />
            <p className="text-center font-[family-name:var(--font-body)] text-sm text-white/60">
              {legalNotice}
            </p>
