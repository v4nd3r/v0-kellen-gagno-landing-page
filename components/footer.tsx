...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1a1a1a] text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a 
                href="https://instagram.com/kellengagno" 
                target="_blank" 
              ...
              <a 
                href="https://facebook.com/kellengagno" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#c49b63] transition-colors"
                aria-label="Facebook"
      ...
      <a
        href="https://wa.me/5527992743485?text=Ola! Gostaria de mais informacoes sobre imoveis."
        target="_blank"
        rel="noopener noreferrer"
